...
We computed the training and test errors for each of thee 7 models. The stepwise models had the lowest training error, but their higher test errors might be a result of overfitting. 
