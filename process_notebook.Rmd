...
Additionally, we wanted to see what linear models would be created using automatic feature selection. We started with stepwise selection: forward and backward. 
...
error %>% 
    ...
    ggplot() +
    geom_point(aes(x=model_number, y=log10(error), color=type)) +
    geom_line(aes(x=model_number, y=log10(error), color=type)) + 
