...
We allowed the first and second period grades to be considered because otherwise our MSE would be greater than 5. 
...
full1 <- lm(G3 ~ school + sex + age + address + famsize + Pstatus + Medu + Fedu + Mjob +
                ...
                class,data=train)
model6 <- step(null1, scope = list(lower=null1, upper=full1), direction="forward", trace = 0)
model6
...
full1 <- lm(G3 ~ school + sex + age + address + famsize + Pstatus + Medu + Fedu + Mjob +
                ...
                famrel + freetime + goout + Dalc + Walc + health + absences + G1 + G2 +
                class,data=train)
model7 <- step(full1, direction="backward", trace = 0)
model7
