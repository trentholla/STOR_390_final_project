...
Students were graded on a scale from 0 to 20. Quite a large number of students received as 0 as their final grade. We assumied that other, undocumented factors led to that final score (e.g. the student did not take the assessment) and therefore removed these observations from the data. We also removed the sole student with a final grade of 1 as an outlier. 
...
ggplot(data, aes(x = studytime, y = G3))+ 
    geom_boxplot(color = "maroon4", size = 1) + 
