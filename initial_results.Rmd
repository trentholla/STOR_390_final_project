...
ggplot(data, aes(x = romantic, fill = studytime)) + 
    geom_bar(position = "fill") + 
    scale_y_continuous(labels = percent) +
    labs(x = "In a romantic relationship?", y = "Percent of Population", title = "Students in relationships tend to study more") 
```
...
ggplot(data, aes(x = sex, fill = Dalc)) + 
    ...
    labs(x = "Sex", y = "Percent of Population", title = "Male students drink more than females on workdays", color = "Workday Alcohol Consumption") +
    theme_classic()
...
ggplot(data, aes(x = sex, fill = Walc)) + 
    ...
    scale_y_continuous(labels = percent) +
    scale_x_discrete(labels = c("Female" , "Male")) +
    labs(x = "Sex", y = "Percent of Population", title = "All students increase alcohol consumption on the weekend", color = "Weekend Alcohol Consumption") +
    theme_classic()
```
